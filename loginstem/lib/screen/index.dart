...
class Urltable extends StatefulWidget {
  const Urltable({super.key});

  @override
  State<Urltable> createState() => _UrltableState();
}

class _UrltableState extends State<Urltable> {
  @override
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: TextField(
                cursorColor: const Color.fromARGB(255, 137, 187, 218),
